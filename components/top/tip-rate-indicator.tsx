...
export function TipRateIndicator({ stats }: { stats: TipRateStats }) {
  ...
  return (
    <section className="mb-8 overflow-hidden rounded-2xl border border-cyan-200/70 bg-gradient-to-br from-sky-50 via-cyan-50 to-teal-50 p-5 shadow-sm sm:p-6 dark:border-cyan-900/50 dark:from-sky-950/30 dark:via-cyan-950/20 dark:to-teal-950/20">
          ...
          <div className="relative h-36 w-36">
            <svg viewBox="0 0 140 140" className="h-full w-full -rotate-90">
              <circle
                ...
                fill="none"
                strokeWidth="12"
                className="stroke-cyan-100 dark:stroke-cyan-900/50"
              />
              <circle
                cx="70"
                cy="70"
